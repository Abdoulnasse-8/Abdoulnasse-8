...
<td width="180" align="center">
  <img src="https://avatars.githubusercontent.com/u/175497164?v=4" width="130" style="border-radius:50%; border: 3px solid #B0842B;" />
  <br><br>
...
Plateforme PaaS self-hosted — `git push → HTTPS en < 2 min`
...
|:---|:---|:---|
| ⚡ **Mini-Heroku** | Plateforme PaaS self-hosted | [→](https://github.com/Abdoulnasse-8/mini-heroku) |
| 🏥 **CabinetMedical** | Application médicale 3 tiers | [→](https://github.com/Abdoulnasse-8/CabinetMedical) |
...
### *"Le terrain m'a appris la discipline, le code m'a appris la logique. Les deux, la persévérance."*
